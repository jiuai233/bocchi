...
export default function LandingPage({
    ...
    return (
        <main className="min-h-screen relative flex flex-col items-center overflow-hidden">
                ...
                <div className="z-10 text-center space-y-4">
                    ...
                    >
                        <GlitchText
                            ...
                            as="h1"
                        />
                        <p className="text-xl md:text-2xl text-gray-400 font-bold tracking-widest mt-2">
                            结束乐队
                        </p>
                    </motion.div>
                    ...
                    >
                        <span className="text-bocchi-pink font-mono text-lg font-bold">
                            [ 后藤独 ]
                        </span>
                        <span className="text-kita-red font-mono text-lg font-bold">
                            [ 喜多郁代 ]
                        </span>
                        <span className="text-ryo-blue font-mono text-lg font-bold">
                            [ 山田凉 ]
                        </span>
                        <span className="text-nijika-yellow font-mono text-lg font-bold">
                            [ 伊地知虹夏 ]
                        </span>
                    </motion.div>
                </div>
                        ...
                        >
                            <div className="bg-yellow-50 p-8 rounded-2xl border-2 border-dashed border-nijika-yellow relative">
                                ...
                                <div className="space-y-4 text-gray-600 font-mono leading-relaxed">
                                    ...
                                    <p>如果你关注我的频道……我会看的……大概……</p>
                                </div>
                                <div className="mt-6 flex gap-3 flex-wrap">
                                    <span className="bg-ryo-blue text-white px-3 py-1 rounded-full text-sm font-bold shadow-md">
                                        #社恐
                                    </span>
                                    <span className="bg-kita-red text-white px-3 py-1 rounded-full text-sm font-bold shadow-md">
                                        #吉他
                                    </span>
                                    <span className="bg-bocchi-pink text-white px-3 py-1 rounded-full text-sm font-bold shadow-md">
                                        #结束乐队
                                    </span>
                                </div>
                            </div>
            ...
            {/* Guestbook Section */}
            <section className="w-full py-20 bg-gloom-black relative border-t border-gray-800">
                <div className="container mx-auto px-4 max-w-4xl">
                    <h2 className="text-4xl font-bold text-white mb-12 text-center font-rubik">
                        <span className="text-bocchi-pink">GUEST</span>
                    ...
                    <div className="grid md:grid-cols-2 gap-12">
                        ...
                        <div className="space-y-4">
                            <h3 className="text-xl font-bold text-gray-400 mb-4 font-mono pl-2 border-l-4 border-nijika-yellow">
                                最近留言 / Recent
                            </h3>
            ...
            <footer className="w-full py-12 bg-black text-white text-center border-t border-gray-800">
                <p className="font-mono text-sm opacity-50">Jiuai233</p>
            </footer>
        </main>
    );
}
